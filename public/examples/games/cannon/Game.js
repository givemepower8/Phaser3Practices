...
var Bullet = new Phaser.Class({
  ...
  initialize: function Bullet(data) {
...
var Invader = new Phaser.Class({
  ...
  initialize: function Invader(data) {
    Mesh.call(this, data, 0, 0, 0);
...
var Cannon = new Phaser.Class({
  ...
  preload: function() {
    this.load.text('bullet', 'assets/bullet.obj');
    this.load.text('tank', 'assets/ship.obj');
    this.load.text('invader', 'assets/invader.obj');
    this.load.text('grid', 'assets/grid.obj');
  },
